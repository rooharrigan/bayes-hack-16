...
def gets_min_travel_to_location_from_user(user_lat, user_lon, loc_lat, loc_lon, transit_mode):
...
def gets_min_travel_to_location_from_user(user_lat, user_lon, locations):
    ...
    for location in locations:
        transit = gets_min_travel_to_location_from_user(user_lat, user_lon, loc_lat, loc_lon, "transit")
        car = gets_min_travel_to_location_from_user(user_lat, user_lon, loc_lat, loc_lon, "car")
        new_locations.append((location[0], location[1]), location[2], location[3], transit, car)
